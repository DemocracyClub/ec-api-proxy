...
@pytest.mark.parametrize(
    "env,expected",
    [
        ("production", "api-users/ec-api/latest/"),
        ("development", "api-users/ec-api/development/latest/"),
        ("staging", "api-users/ec-api/staging/latest/"),
        (None, "api-users/ec-api/local-dev/latest/"),
